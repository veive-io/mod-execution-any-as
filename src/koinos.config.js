...
module.exports = {
  ...
  filesImport: [
    {
      dependency: "@veive/mod-execution-as",
      path: "../node_modules/@veive/mod-execution-as/dist/ModExecution.ts",
    },
  ],
  protoImport: [
    {
      name: "@veive/mod-execution-as",
      path: "../node_modules/@veive/mod-execution-as/dist/proto/modexecution",
    },
    {
