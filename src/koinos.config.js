...
module.exports = {
  class: "ModExecutionAny",
  proto: ["./proto/modexecutionany.proto"],
  files: ["./ModExecutionAny.ts"],
  supportAbi1: true,
  sourceDir: "./assembly",
  buildDir: "../build",
  filesImport: [
    {
      dependency: "@veive-io/mod-execution-as",
      path: "../node_modules/@veive-io/mod-execution-as/dist/ModExecution.ts",
    },
  ],
  protoImport: [
    {
      name: "@veive-io/mod-execution-as",
      path: "../node_modules/@veive-io/mod-execution-as/dist/proto/modexecution",
    },
    {
